...
export default function ManageBudgetBtn({ budget }: ManageBudgetBtnProps) {
			...
			>
				<Modal>
					...
					<Modal.Window name='modifyBudget'>
						<ModifyBudgetModal onCloseModal={() => undefined} budget={budget} />
					</Modal.Window>
				</Modal>
				<Modal>
					...
					<Modal.Window name='deleteBudget'>
						<DeleteBudgetModal onCloseModal={() => undefined} budget={budget} />
					</Modal.Window>
				</Modal>
				<Modal>
