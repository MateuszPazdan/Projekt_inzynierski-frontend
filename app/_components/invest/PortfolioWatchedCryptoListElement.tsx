...
import { thStyles } from './crypto/PortfolioWatchedCryptoList';
import {
	WatchedCrypto,
	WatchedStocks,
...
interface PortfolioWatchedListElementProps {
	watchedElement?: WatchedCrypto | WatchedStocks;
...
export default function PortfolioWatchedListElement({
	...
	return (
		<tr
			onClick={() =>
				router.push(`${portfolioId}/${watchedElement.[assetType].symbol}`)
			}
