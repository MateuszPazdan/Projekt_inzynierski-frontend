...
export default function page() {
	return (
		<div className='lg:bg-white rounded-lg lg:border lg:shadow-md border-grayThird p-2 sm400:p-5 lg:p-2 grid grid-cols-1 lg:grid-cols-[2fr_3fr] w-full sm:w-2/3 lg:w-auto h-fit'>
